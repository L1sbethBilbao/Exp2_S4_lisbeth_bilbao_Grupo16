...
├── config/          3 Jobs master/worker, PartitionTaskExecutor, lectores de rango
...
El wallet **no** va dentro de este proyecto. Queda al lado:

`C:/Users/lisbe/OneDrive/Escritorio/backend_semana_3/Wallet_miQuintaBD`
